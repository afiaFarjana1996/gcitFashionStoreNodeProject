...
exports.addCustomer = function(customer , cb){
    db.beginTransaction(function(err){
        ...
        db.query('insert into customers(email,password,name,address,phone,registerDate,creditCardId) values(?,?,?,?,?,?,?)',[customer.email,sha1(customer.password),customer.name,customer.address,customer.phone,customer.registerDate,customer.creditCardId], function(err, result){
          if(err){
